...
for ag in np.unique(subdata['agent']):
    ...
    fits.to_csv(path+"model_recov_poisson_{}.csv".format(g))

np.save(path+"AS_pars_poisson_{}.npy".format(g),AS_pars)
np.save(path+"DB_pars_poisson_{}.npy".format(g),DB_pars)
np.save(path+"VS_pars_poisson_{}.npy".format(g),VS_pars)
np.save(path+"SG_pars_poisson_{}.npy".format(g),SG_pars)
np.save(path+"nLL_AS_poisson_{}.npy".format(g),nLL_AS)
np.save(path+"nLL_DB_poisson_{}.npy".format(g),nLL_DB)
np.save(path+"nLL_VS_poisson_{}.npy".format(g),nLL_VS)
np.save(path+"nLL_SG_poisson_{}.npy".format(g),nLL_SG)