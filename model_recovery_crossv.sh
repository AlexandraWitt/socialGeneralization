#!/bin/bash
#SBATCH -J socGen_modelrec
#SBATCH -n 1                             # N cores
#SBATCH -N 1                              # All cores on one machine
#SBATCH -p cpu-short                       # Partition name
#SBATCH --time=0-09:30            # Runtime in D-HH:MM
...
python3 ./simulation/modelRecovery.py $SLURM_ARRAY_TASK_ID
conda deactivate 
